...
class MotionPlanner:
    def __init__(self, model, T=1, N=50, nlp_solver='ipopt'):
        ...
        self.r_final = np.array([-x_default*2, 0.0, 0.468])
        ...
        self.p_left_rear_final = R@np.array([-3*x_default, y_default, 0.0])
        self.p_right_rear_final = R@np.array([-3*x_default, -y_default, 0.0])
        ...
        q_fin_cost = 100*sumsqr(self.q[:, (self.N1+self.N2):] - self.q_final) + sumsqr(self.qd[:, -1])
