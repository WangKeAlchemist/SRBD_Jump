...
class SingleRigidBodyModel:
    ...
    def update_inertia(self, pos_lf, pos_lh, pos_rf, pos_rh):
        ...
        self.I_body_inv = blockcat([[1./((pos_lf[1]**2+pos_lh[1]**2+pos_rf[1]**2+pos_rh[1]**2+(pos_lf[2]**2+pos_lh[2]**2+pos_rf[2]**2+pos_rh[2]**2)/4)*self.leg_mass+0.33904), 0.,0.],
                       [0.,1./((pos_lf[0]**2+pos_lh[0]**2+pos_rf[0]**2+pos_rh[0]**2+(pos_lf[2]**2+pos_lh[2]**2+pos_rf[2]**2+pos_rh[2]**2)/4)*self.leg_mass+1.872),0.],
